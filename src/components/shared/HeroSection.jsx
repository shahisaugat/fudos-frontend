...
const HeroSection = () => {
  return (
    <div className="flex flex-col md:flex-row items-center justify-between p-8 bg-background text-foreground sm:ml-6 sm:mr-6">
      <div className="md:w-2/3 md:order-1 md:mr-6 ml-2">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center space-y-4 sm:space-y-0 sm:space-x-4 mt-8">
          <Link to="/menu" className="bg-[#EB5757] text-white font-semibold py-2 px-4 rounded-lg hover:bg-[#EB5757]/80">
          <button className="bg-[#EB5757] text-white font-semibold py-2 px-4 rounded-lg hover:bg-[#EB5757]/80">
            Order Now
          </button>
          </Link>
      ...
      <div className="md:w-1/3 md:order-2 md:mt-4 my-8">
